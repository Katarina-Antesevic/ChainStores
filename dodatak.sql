...
grant execute on procedure lanac_prodavnica.maksimalna_plata_Zaposlenog to 'referent'@'localhost';
grant execute on procedure lanac_prodavnica.minimalna_plata_Zaposlenog to 'referent'@'localhost';
flush privileges;
