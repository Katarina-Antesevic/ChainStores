...
-- call maksimalna_plata_zaposlenog_u_Prodavnici(1,@retVal);
-- select @retVal;
...
-- call maksimalna_plata_zaposlenog_u_Magacinu(2,@maxx);
-- select @maxx;
...
call minimalna_plata_zaposlenog_u_Prodavnici(3,@m);
select @m;
