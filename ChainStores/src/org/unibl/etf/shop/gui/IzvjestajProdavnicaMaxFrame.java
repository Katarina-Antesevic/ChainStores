...
public class IzvjestajProdavnicaMaxFrame extends JFrame{
	 ...
	 * Create the frame.
	 */
	public IzvjestajProdavnicaMaxFrame() {
	...
	private void osveziTabelu() {
			...
			trgovci = Utilities.getDataAccessFactory().getIzvjestajiDataAccess().trgovciMax(idOJ);
	...
	private void initialize() {
		setTitle("Maksimalna plata trgovca");
