...
public class IzvjestajMagacinMaxFrame extends JFrame {
private List<Magacioner> magacioneri;
	 ...
	 * Create the frame.
	 */
	public IzvjestajMagacinMaxFrame() {
	...
	private void osveziTabelu() {
			...
			magacioneri = Utilities.getDataAccessFactory().getIzvjestajiDataAccess().magacioneriMax(idOJ);
	...
	private void initialize() {
		setTitle("Maksimalna plata magacionera");
