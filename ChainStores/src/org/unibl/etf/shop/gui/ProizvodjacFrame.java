				...
				public void actionPerformed(ActionEvent arg0) {
					...
					if (pd.getDialogResult().equalsIgnoreCase("OK")) {
						...
						JOptionPane.showMessageDialog(ovaj,
								"Novi proizvodjac je uspešno dodan!", "Poruka",
				...
				public void actionPerformed(ActionEvent e) {
					if (table.getSelectedRow() == -1) {
						...
						if (pd.getDialogResult().equalsIgnoreCase("OK")) {
							osveziTabeluZaSve();
							JOptionPane.showMessageDialog(ovaj,
									"Proizvodjac je uspešno ažuriran!", "Poruka",
									JOptionPane.INFORMATION_MESSAGE);
						}
					}
				}
				...
				public void actionPerformed(ActionEvent e) {
					if (table.getSelectedRow() == -1) {
						...
						int odabir = JOptionPane
								.showOptionDialog(
										ovaj,
										"Da li ste sigurni da želite obrisati odabranog proizvodjaca?",
										"Potvrda brisanja",
						...
						if (odabir == JOptionPane.YES_OPTION) {
							if (Utilities
								...
								osveziTabeluZaSve();
								JOptionPane.showMessageDialog(ovaj,
										"Proizvodjac je uspešno obrisan!",
										"Poruka",
										JOptionPane.INFORMATION_MESSAGE);
							} else
								JOptionPane.showMessageDialog(ovaj,
										"Proizvodjac nije uspešno obrisan!",
										"Poruka",
										JOptionPane.INFORMATION_MESSAGE);
						}
					}
