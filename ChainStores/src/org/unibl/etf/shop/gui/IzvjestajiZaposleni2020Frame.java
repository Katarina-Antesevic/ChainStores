...
public class IzvjestajiZaposleni2020Frame extends JFrame{
	 ...
	 * Create the frame.
	 */
	public IzvjestajiZaposleni2020Frame() {
		...
		setTitle("Zaposleni u 2020. godini");

		podaci = Utilities.getDataAccessFactory().getIzvjestajiDataAccess().zaposleni2020();
