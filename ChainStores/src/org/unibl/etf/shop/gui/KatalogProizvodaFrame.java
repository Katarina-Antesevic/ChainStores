				...
				public void actionPerformed(ActionEvent arg0) {
					...
					if (pd.getDialogResult().equalsIgnoreCase("OK")) {
						...
						JOptionPane.showMessageDialog(ovaj,
								"Novi proizvod je uspešno dodan u organizacionu jedinicu!", "Poruka",
			...
			btnIzmeniti.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (table.getSelectedRow() == -1) {
						JOptionPane.showMessageDialog(ovaj,
								"Proizvod iz organizacione jedinice nije odabran!", "Greška",
						...
						if (pd.getDialogResult().equalsIgnoreCase("OK")) {
							osveziTabeluZaSve();
							JOptionPane.showMessageDialog(ovaj,
									"Proizvod iz organizacione jedinice je uspešno ažuriran!", "Poruka",
									JOptionPane.INFORMATION_MESSAGE);
						}
					}
				}
				...
				public void actionPerformed(ActionEvent e) {
					if (table.getSelectedRow() == -1) {
						...
						int odabir = JOptionPane
								.showOptionDialog(
										ovaj,
										"Da li ste sigurni da želite obrisati odabrani proizvod iz organizacione jedinice?",
										"Potvrda brisanja",
						...
						if (odabir == JOptionPane.YES_OPTION) {
							if (Utilities
								...
								osveziTabeluZaSve();
								JOptionPane.showMessageDialog(ovaj,
										"Proizvod iz organizacione jedinice je uspešno obrisan!",
										"Poruka",
										JOptionPane.INFORMATION_MESSAGE);
							} else
								JOptionPane.showMessageDialog(ovaj,
										"Proizvod iz organizacione jedinice nije uspešno obrisan!",
										"Poruka",
										JOptionPane.INFORMATION_MESSAGE);
						}
					}
